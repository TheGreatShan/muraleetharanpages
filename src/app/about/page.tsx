    ...
    return (
        <Design>
            ...
            <p className={"mt-4 mx-[50px]"}>
                Hi, I'm a software developer with a passion for creating web applications using React and C#. I started
                ...
                technologies, and collaborating with other developers. My goal is to build user-friendly, responsive,
                and scalable websites that can make a positive impact on the world. This portfolio showcases some of my

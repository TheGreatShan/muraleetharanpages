                    ...
                    <div className="md:flex md:items-start md:gap-8">
                        <div className="flex-1">
                            <h2 className="text-[16pt] md:text-[20pt] font-bold mb-4 text-center md:text-left">
                                Hi, I&apos;m Shansai <span role="img" aria-label="waving hand">👋</span>
                            </h2>
                            <p className="mb-4 leading-relaxed">
                                <span className="font-semibold">Software Engineer and IT Consultant</span> specializing in C# and Azure cloud solutions. <span role="img" aria-label="rocket">🚀</span>
                            </p>
                            <p className="mb-4 leading-relaxed">
                            ...
                            <p className="mb-4 leading-relaxed">
                                Alongside my professional work, I&apos;m pursuing my studies at <span className="font-semibold">ZHAW (Zurich University of Applied Sciences)</span>, deepening my knowledge in computer science fundamentals, discrete mathematics, and software architecture. <span role="img" aria-label="books">📚</span>
                            </p>
                            <p className="mb-4 leading-relaxed">
                            ...
                            <p className="mb-4 leading-relaxed">
                                Beyond my work at KPMG, I&apos;m <span className="font-semibold">co-founder of Anywell</span>, an early-stage Swiss startup currently in development. <span role="img" aria-label="light bulb">💡</span>
                            </p>
                        ...
                        <div className="bg-[#dcd4fe] text-black rounded-lg p-6">
                            ...
                            <div className="flex flex-wrap justify-center gap-3">
                                ...
                                <a 
                                    ...
                                    className="bg-white text-blue-600 px-6 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
                                >
                                    <span role="img" aria-label="laptop">💻</span> GitHub
                                </a>
                            </div>
                        </div>
                    </div>
